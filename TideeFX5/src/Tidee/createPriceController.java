			...
			if (tableItems != null) {
				...
				if (buttonChosen.equals("clearance")) {
					statement="insert into `clearanceevent` (`eventID`, `eventDate`, `itemID`, `secLoc`, `subLoc`, "
							+ "`markdownPrice`, `depNum`) values ('"+eventID.getText()+"', '"+calendar.getValue().toString()+
							"', '"+tableItems.getItemID()+"', '"+field1.getText()+"', '"+field2.getText()+"', '"+
							newPrice.getText()+"', '"+depNum.getText()+"');";
					}
					
				else {
					statement="insert into `salesevent` (`eventID`, `eventDate`, `itemID`, `secLoc`, `subLoc`, "
							+ "`markdownPrice`, `duration`, `depNum`) values ('"+eventID.getText()+"', '"+calendar.getValue().toString() +
							"', '"+tableItems.getItemID()+"', '"+field1.getText()+"', '"+field2.getText() + "', '" +
							newPrice.getText() + "', '" + duration.getText() + "', '"+depNum.getText()+"');";
				}
