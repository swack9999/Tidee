...
public class ItemPageController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources){
		...
		storeSub.setText(GlobalConstants.displayedItem.getStoreSubLocation());
		storeSec.setText(GlobalConstants.displayedItem.getStoreSecLocation());
